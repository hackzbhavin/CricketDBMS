...
if (isset($_REQUEST['TEAM'])){
        ...
        $query = "UPDATE  odi_rank SET TEAM='$team',MATCHES_PLAYED='$match', wins='$win', lost='$lose', NRR='$nrr',POINTS='$points',RATINGS='$ratings',RANK='$rank',WORLD_CUPS='$wc' WHERE id=$id";
...
?>
<?php 
$res = mysqli_query($con,"SELECT * FROM  odi_rank where id = $id");
...
<form   method="post" action="" >
        ...
        <div class="input-group">
            <center><h1>Update new Data</h1></center>
