...
<body style="background: linear-gradient(to bottom right, #ffffff 0%, #ffffcc 100%");
    >
<div class="navbar">
<img src="css/sa.png" width="150" height="150"; style="float: left;">

<h1 style="float: left; color:#ffcc99; "font-style: "Comic Sans MS"><center>


{South Africa Database}</center> </h1>
...
<div class="split left">
  <div class="centered">
   <a href="sacoach.php"> <img src="css/coach.png" alt=" Squad"></a>
...
<div class="split right">
  <div class="centered">
    <a href="sasquad.php"> <img src="css/squad1.png" alt="Avatar man"></a>
