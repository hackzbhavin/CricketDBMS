...
$querry = "select * from India order by Player_Role = 'Batsman' desc";
	...
	<tr>
		...
		while ($rows=mysqli_fetch_assoc($result)):?>
			<tr align="center">
				...
				<td><?php echo $rows['shirt'];?></td>
				<td><?php echo $rows['Player_Date_Of_Birth'];?></td>
