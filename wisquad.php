...
$querry = "select * from  WEST_INDIES order by Player_Role = 'bowler' ";
...
<head>
<meta charset="utf-8">
<title>WEST INDIES Database</title>
	...
	<tr>
		...
		while ($rows=mysqli_fetch_assoc($result)):?>
			<tr align="center">
				...
				<td><?php echo $rows['SHIRT_NO'];?></td>
				<td><?php echo $rows['PLAYER_DOB'];?></td>
