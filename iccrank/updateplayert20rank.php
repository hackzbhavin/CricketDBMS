...
if (isset($_REQUEST['rank'])){
        ...
        $query = "UPDATE  iccrankt20 SET rank='$ranks',nat='$nati', first='$fi', last='$la', points='$point' WHERE id=$id";
...
?>
<?php 
$res = mysqli_query($con,"SELECT * FROM  iccrankt20 where id = $id");
...
<form   method="post" action="" >
        ...
        <div class="input-group">
            <center><h1>Update T20 ICC Player Ranking Data</h1></center>
