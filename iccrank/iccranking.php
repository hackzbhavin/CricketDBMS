...
$querry1 = "select * from  iccranktest ";
$querry2 = "select * from  iccrankodi ";
$querry3 = "select * from  iccrankt20 ";
      ...
      <tr align="center">
       ...
       echo '<img src="data:image/jpeg;base64,'.base64_encode( $rows1['image'] ).'"/>';?></td>
        ...
        <td><?php echo $rows1['last'];?></td>
         ...
         <td><?php
               echo "<td><a href='updateplayertestrank.php?id=".$rows1['id']."'><button type='button' class='btn btn-warning'>Update</button></a>";
               ?>
            </td>
    ...
    while ($rows2=mysqli_fetch_assoc($result2)):?>
      <tr align="center">
       ...
       <td><b style="font-size:20px"><?php echo $rows2['nat'];?></b></td>
        ...
        <td><?php
               echo "<td><a href='updateplayerodirank.php?id=".$rows2['id']."'><button type='button' class='btn btn-warning'>Update</button></a>";
               ?>
            </td>
...
<table >
 ...
 <td><?php               
       ...
       <td><b style="font-size:50px"><?php echo $rows3['rank'];?></b></td>
        ...
        <td><?php
               echo "<td><a href='updateplayert20rank.php?id=".$rows3['id']."'><button type='button' class='btn btn-warning'>Update</button></a>";
               ?>
            </td>
