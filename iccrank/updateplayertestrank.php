...
if (isset($_REQUEST['rank'])){
        ...
        $query = "UPDATE  iccranktest SET rank='$ranks',nat='$nati', first='$fi', last='$la', points='$point' WHERE id=$id";
...
?>
<?php 
$res = mysqli_query($con,"SELECT * FROM  iccranktest where id = $id");
...
<form   method="post" action="" >
        ...
        <div class="input-group">
            <center><h1>Update Test ICC Player Ranking Data</h1></center>
