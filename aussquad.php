...
$querry = "select * from australia order by players_role = 'Batsman' desc ";
...
<head>
<meta charset="utf-8">
<title> Australia Database</title>
...
<body >
	<div class="navbar">
<img src="css/aus.png" width="150" height="150"; style="float: left;">

<h1 style="float: left; color:#ffcc99; "font-style: "Comic Sans MS">


{Australia Squad Database} </h1>
	...
	<tr>
		...
		while ($rows=mysqli_fetch_assoc($result)):?>
			<tr align="center">
				...
				<td><?php echo $rows['players_role'];?></td>
				<td><?php echo $rows['players_shirt'];?></td>
				<td><?php echo $rows['players_birthdate'];?></td>
