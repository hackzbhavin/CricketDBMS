...
$querry = "select * from England order by player_role = 'bowler' ";
...
<body >
	<div class="navbar">
<img src="css/eng.png" width="80" height="90"; style="float: left;">

<h1 style="float: left; color:#ffcc99; "font-style: "Comic Sans MS">


{England Squad Database.} </h1>
